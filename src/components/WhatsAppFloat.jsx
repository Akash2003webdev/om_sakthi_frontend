...
export default function WhatsAppFloat({ designId = '' }) {
  const msg = designId
    ? `Hi, I liked your design (Design ID: ${designId}). I want to order.`
    : `Hi, I'm interested in your printing services at Om Sakthi Printers, Sattur.`
